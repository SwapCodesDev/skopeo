...
export const HistoryManager = ({ currentUrl, onSelectUrl }: HistoryManagerProps) => {
    ...
    // const [isOpen, setIsOpen] = useState(false); // Removed internal toggle
    ...
    return (
        <div className="space-y-1">
            <div className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-2 px-2">Recent Sessions</div>
            {history.map((url, i) => (
                <div
                    key={i}
